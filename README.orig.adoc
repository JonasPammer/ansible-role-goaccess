...
goaccess_conf_log_file__group: "{{ goaccess_conf_file_group }}"
...
goaccess_systemd_description: "Service that generates real-time HTML reports of GoAccess using configuration in {{ goaccess_conf_file }}"
----
